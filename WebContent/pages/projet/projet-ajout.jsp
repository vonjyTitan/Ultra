...
function addChildEstim(){
	...
	node+="<td style=\"width: 100px;\"><input type=\"text\" class=\"money number\" name=\"estimation\"/></td><td><a href=\"javascript:;\" name=\"suppr\" class=\"suppr btn btn-danger btn-xs\"><i class=\"fa fa-trash-o\"></i></a></td></tr>";
